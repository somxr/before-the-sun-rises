...
func get_texture_for_variant(variant_type: PropVariant) -> Texture2D:
	match variant_type:
		PropVariant.VARIANT_A:
			return preload("uid://dvtvkbmmsmgqx")
		PropVariant.VARIANT_B:
			return preload("uid://cidtoels6860q")
		PropVariant.VARIANT_C:
			return preload("uid://mw6x52q1eeuw")
		PropVariant.VARIANT_D:
			return preload("uid://cg5t5y6esgsd1")
		PropVariant.VARIANT_E:
			return preload("uid://cgvslr6m83eaq")
		_:
			return null
